...
import 'package:todo_app/feat/edit_todo/bloc/edit_todo_bloc.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          isNewTodo
              ? strings.editTodoAddAppBarTitle
              : strings.editTodoEditAppBarTitle,
        ),
      ),
      floatingActionButton: FloatingActionButton(
        tooltip: strings.editTodoSaveButtonTooltip,
